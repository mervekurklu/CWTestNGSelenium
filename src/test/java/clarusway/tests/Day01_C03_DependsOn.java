...
public class Day01_C03_DependsOn {//destek demek
    ...
    //bağlı olduğu meth passed ederse geçer yine failed ederse geçmez..bağımlı olunan test daha önce çalışır
    //birdeb fazla değer verirsek bağladığımız met geçmesi lazım passed olması için
