...
public class BaseTestReport {
    ...
    @AfterMethod
    public void teardown(ITestResult result) throws IOException {// bizim için gömülü bir interface testng tarafından düzenlenmiş
        // arka planda belirteceğim parametreler var aytest conteks ve result gibi bir testin geçip geçemdiğini kpntrol edebilriz bunlar listener olarak isimlendirilir
        //test fail olduğunda ekran ss almayı sağlar aasıl amaç
        //test esnasında ise aytest conteks oluyor.
        if (result.getStatus() ==ITestResult.FAILURE){
           String screenShotLocation = ReusableMethods.getScreensShot(driver,result.getName());
